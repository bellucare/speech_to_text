        ...
        try {
            when (call.method) {
                ...
                "listen" -> {
                    ...
                    var pauseFor = call.argument<Int>("pauseFor")
                    if ( null == pauseFor ) {
                        pauseFor = 5000
                    }
            ...
            handler.post {
                run {
                    recognizerIntent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
                        ...
                        Log.d("SpeechToText","[SpeechToText.Android] RecognizerIntent.EXTRA_SPEECH_INPUT_POSSIBLY_COMPLETE_SILENCE_LENGTH_MILLIS set : $pauseFor")
                        putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_POSSIBLY_COMPLETE_SILENCE_LENGTH_MILLIS, pauseFor)
                        Log.d("SpeechToText","[SpeechToText.Android] RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS set : $pauseFor")
                        putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS, pauseFor - 200)
